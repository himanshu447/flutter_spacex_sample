...
class HistoryRepository{
	...
	Future<List<HistoryModel>> fetchHistory({int offset = 0}) async {
		var queryParameters = {
			'limit': '5',
			'offset' : offset.toString(),
		};
		
		var uri = Uri.parse('${ConstantUtils.host_api}history');
		...
		if (response.statusCode == 200) {
			...
			return (convertJson as List)
					.map((el) => HistoryModel.fromMap(el as Map<String, dynamic>))
					.toList();
		}
